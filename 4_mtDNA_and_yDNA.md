...
But this one actually has some sites that are missing because it was generated by GenotypeVCFs after CombinegVCFs.  So better to use this one:

```
/work/ben/2017_SEAsian_macaques/SEAsian_macaques_bam/females_and_males/FandM_chrM_BSQR.g.vcf.gz
```
