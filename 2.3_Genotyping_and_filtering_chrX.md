...
Then I used this gatk command to generate a table that will be used for filtering based on depth (described on a different github page):
```
java -Xmx2g  -jar $EBROOTGATK/GenomeAnalysisTK.jar -T VariantsToTable -R /home/ben/projects/rrg-ben/ben/2017_SEAsian_macaques/MacaM/MacaM_mt_y.fa -V all_diploid_haploid_chrX_BSQR_filtered2_noPAR.vcf.gz.recode.vcf.gz -F CHROM -F POS -GF DP -o GVCF_chrX_gf_DP.table
```
